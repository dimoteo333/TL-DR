    ...
    def __init__(self, data=None, device=None,  is_test=False):
        ...
        if data is not None:
            ...
            if (is_test):
                ...
                # for test only
                # src_org_str = [x[6] for x in data]
                # setattr(self, 'src_org_str', src_org_str)
                # tgt_org_str = [x[7] for x in data] # check if works
                # setattr(self, 'tgt_org_str', tgt_org_str)
...
class DataIterator(object):
    ...
    def preprocess(self, ex, is_test):
        ...
        # for test only
        # src_org_txt = ex['src_org_txt']
        # tgt_org_txt = ex['tgt_org_txt']

        if(is_test):
            return src,labels,segs, clss, src_txt, tgt_txt #, src_org_txt, tgt_org_txt
        else:
